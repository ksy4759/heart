...
<script>
	...
	$(document).ready(function(){
		...
		if ( mode == 'edit'){
			...
			$("#text").val('<c:out value="${boardContent.text}"/>');
		...
		<div class="container" role="main">
			...
			<form:form name="form" id="form" role="form" modelAttribute="boardVO"
				...
				<div class="mb-3">
					...
					<form:textarea path="text" id="text" class="form-control" rows="5"
				...
				<div class="mb-3">
					...
					<label for="cate_cd">CATE_CD</label>

					<form:input path="cate_cd" id="cate_cd" class="form-control"
						placeholder="태그를 입력해 주세요" />
